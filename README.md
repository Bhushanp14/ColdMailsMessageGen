...
A powerful, AI-driven tool designed to help freelancers, developers, and agency owners generate personalized cold outreach content at scale. Built with **Django**, **React**, and powered by **Google Gemini 2.5 Flash**.
...
- **Customizable Persona**: Set your role (Developer, Designer, Freelancer) and mention if you have a demo site ready to tailor the AI's pitch.
...
2. **Configure Pitch**: Select your "Sender Role" and toggle whether you have a "Demo Site" ready.
